# -*- coding: utf-8 -*-
#
# aws_bedrock_agent_core_poc documentation build configuration file, created by
...
import aws_bedrock_agent_core_poc as package
...
# Add data for Jinja2
try:
    from aws_bedrock_agent_core_poc.docs import doc_data
except:
    doc_data = dict()
