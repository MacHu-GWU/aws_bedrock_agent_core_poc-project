...
### aws_bedrock_agent_core_poc/auth/permissions.py
...
**Rendered as**: Configures components from `aws_bedrock_agent_core_poc.auth.users` and `aws_bedrock_agent_core_poc.auth.permissions` modules.
